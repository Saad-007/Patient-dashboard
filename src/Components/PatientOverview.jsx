  ...
  return (
    <div className="bg-white rounded-[30px] shadow-sm p-8">
      ...
      <div className="flex flex-col items-center mb-8">
        ...
        {/* CHANGED SIZE HERE: w-48 h-48 (192px) */}
        <div className="w-42 h-42 rounded-full overflow-hidden mb-6 border-4 border-white shadow-md">
        ...
        <h3 className="text-2xl font-bold text-[#072635] text-center">
          {patientData.name}
        </h3>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-4">
           ...
           <div>
             ...
             <p className="text-sm font-bold text-[#072635]">{patientData.date_of_birth}</p>
           </div>
        </div>
        ...
        <div className="flex items-center gap-4">
           ...
           <div>
             <p className="text-xs text-[#072635]">Gender</p>
      ...
      <button className="w-full mt-8 py-3 bg-[#01F0D0] hover:bg-[#01d0b5] text-[#072635] font-bold rounded-[40px] transition-colors">
